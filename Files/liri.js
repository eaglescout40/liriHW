...
var spotifyThisSong = function(trackQuery) {
	...
	if(trackQuery === undefined) {
		trackQuery = "zombie jamboree rockapella";
	}
...
if(command === "my-tweets") {
	...
	fs.readFile("random.txt", "utf-8", function(error, data) {
		...
		if(command === "my-tweets") {
			...
			console.log("Request is not a valid request! Please, try again.")
		}
	});
} else if(command === undefined) { // use case where no command is given
	console.log("Enter a request to run LIRI.")
